...
provenance_note: "Compiled on 2026-04-08 from merged PR history and current governance corpus; inferred mappings were moved to a separate proposed sidecar on 2026-04-08."
...
Inferred mappings are intentionally excluded from this canonical ledger and must be reviewed in non-canonical governance lanes before any canonical inclusion.

...
Then create the staged research packet from the attached seed files under `incoming/research/human-person-formation-core-slice/`.
...
Run relevant validation and open PR titled `Seed human person and formation core slice`.
